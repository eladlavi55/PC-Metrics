...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a1wqd7zsjd6ym4-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert GamingPC4.cert.pem --key GamingPC4.private.key --client_id basicPubSub --topic sdk/test/python --count 0